...
import { ApiClient } from './trip_api/api_client';
import { Activities } from './trip_api/activities';
import { Notifications} from './trip_api/notifications';
import { Calendar } from './trip_api/calendar';
...
class TripTogetherApp {
    ...
    constructor(userID: string, tripID: string) {
        ...
        this.calendar = new Calendar(tripID);
        this.activities = [];
        this.notifications = [];
    }
...
const TripSettings: React.FC = () => {
  ...
  return (
    <div>
      ...
      <InviteButton onCopyInvite={handleCopyInvite} />
      {/* ...other settings content... */}
    </div>
  );
};
